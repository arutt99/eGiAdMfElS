...
All ten abilities are implemented, including mandatory bank choices, chained abilities, Anchor protection, Key and Chest bonuses, Oracle reveals, and the Kraken counting cards from every source. Protected Key and Chest cards collected via Anchor also earn the bonus. Bonus cards enter the bank directly without triggering abilities. The built-in guide explains every suit and edge case.
